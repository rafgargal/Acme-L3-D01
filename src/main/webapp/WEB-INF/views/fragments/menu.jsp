...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.assistant" access="hasRole('Assistant')">
			...
			<acme:menu-suboption code="master.menu.assistant.my-dashboard" action="/assistant/assistant-dashboard/show"/>
		...
		<acme:menu-option code="master.menu.lecturer" access="hasRole('Lecturer')">
			...
			<acme:menu-suboption code="master.menu.lecturer.lecture" action="/lecturer/lecture/listAll"/>
		</acme:menu-option>

		<acme:menu-option code="master.menu.auditor" access="hasRole('Auditor')">
			<acme:menu-suboption code="master.menu.auditor.audit" action="/auditor/audit/list"/>
			<acme:menu-suboption code="master.menu.auditor.auditingRecord" action="/auditor/auditingRecord/list"/>
		</acme:menu-option>
